...
class BuildHawkeyTest(RpgTestCase):
    ...
    def test_hawkey_project(self):
        ...
        self.base.spec.Summary = "Library providing simplified C \
                                  and Python API to libsolv"
        self.base.spec.description = (
            "A Library providing simplified C and Python API to libsolv.")
        self.base.spec.URL = "https://github.com/\
            rpm-software-management/%{name}"
        ...
        self.base.spec.BuildRequires.union(['cmake', 'expat-devel',
            'rpm-devel', 'zlib-devel', 'check-devel',
            'python-nose', 'python-sphinx', 'python2-devel'])
